<template>
  <nav>
    ...
    <!-- toggle menu -->
    <transition>
      <div class="toggleMenu" v-if="isHidden">
        <ul>
  ...
  data() {
    return {
      menuItems: [
        { item: "Home", key: "0001" },
        { item: "About", key: "0002" },
        { item: " Contact", key: "0003" },
        { item: "Blog", key: "0004" },
        { item: "Careers", key: "0005" },
      ],

      closeMenu: [{ img: "../assets/icon-close.svg" }],
...
$nav-shadow: hsl(0, 0%, 80%);
$breakpoint-tablet: 730px;
$breakpoint-laptop: 1070px;
